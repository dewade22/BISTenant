...
function isiThead(result, date) {
    for (let i = 0; i < result.sales; i++) {
        let thead = `<th style="width:400px" colspan=3><a href="${baseurl}/Balimoon/SalesActual/DetilSalesBoard?dateTime=${date}&sales=${result.hasil[i].salesPerson}">${result.hasil[i].salesPerson}</a></th>`
